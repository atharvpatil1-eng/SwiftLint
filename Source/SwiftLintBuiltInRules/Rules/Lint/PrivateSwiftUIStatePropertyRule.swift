...
private extension PrivateSwiftUIStatePropertyRule {
    ...
    final class Rewriter: ViolationsSyntaxRewriter<ConfigurationType> {
        ...
        override func visit(_ node: VariableDeclSyntax) -> DeclSyntax {
            ...
            let previousAccessModifierLeadingTrivia = Trivia(pieces: existingAccessLevelModifiers.flatMap(\.leadingTrivia.pieces))
            let previousAccessModifierTrailingTrivia = Trivia(pieces: existingAccessLevelModifiers.flatMap(\.trailingTrivia.pieces))
